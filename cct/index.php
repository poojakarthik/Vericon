...
<head>
<title>VeriCon :: Customer Care</title>
...
<?php
$check = mysql_query("SELECT * FROM announcements WHERE (department = 'cct' OR department = 'all') AND display = 'Yes'") or die(mysql_error());
...
else
{
	...
	$q = mysql_query("SELECT * FROM announcements WHERE (department = 'cct' OR department = 'all') AND display = 'Yes' ORDER BY id DESC LIMIT $st , 4") or die(mysql_error());
