...
$id = $_GET["id"];
$q0 = mysql_query("SELECT campaign FROM vericon.customers WHERE id = '" . mysql_real_escape_string($id) . "'") or die(mysql_error());
...
$q = mysql_query("SELECT * FROM vericon.packages WHERE id = '" . mysql_real_escape_string($id) . "'");
