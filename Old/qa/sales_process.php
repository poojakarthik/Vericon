...
elseif ($method == "approve_au")
{
	...
	else
	{
		...
		mysql_query("INSERT INTO vericon.customers (id, status, last_edit_by, industry, lead_id, sale_id, timestamp, agent, centre, campaign, type, title, firstname, middlename, lastname, dob, email, mobile, billing, welcome, promotions, physical, postal, id_type, id_num, abn, position, best_buddy, credit, ongoing_credit, onceoff_credit, promo_code, promo_cli, promo_plan, payway, dd_type, billing_comments, other_comments) VALUES ('$account_number', 'Waiting Welcome Call', '$verifier', '$data[industry]', '$data[lead_id]', '$data[id]', '$timestamp', '$data[agent]', '$data[centre]', '$data[campaign]', '$data[type]', '" . mysql_real_escape_string($data["title"]) . "', '" . mysql_real_escape_string($data["firstname"]) . "', '" . mysql_real_escape_string($data["middlename"]) . "', '" . mysql_real_escape_string($data["lastname"]) . "', '" . mysql_real_escape_string($data["dob"]) . "', '" . mysql_real_escape_string($data["email"]) . "', '" . mysql_real_escape_string($data["mobile"]) . "', '$data[billing]', '$data[welcome]', '$data[promotions]', '$data[physical]', '$data[postal]', '" . mysql_real_escape_string($data["id_type"]) . "', '" . mysql_real_escape_string($data["id_num"]) . "', '" . mysql_real_escape_string($data["abn"]) . "', '" . mysql_real_escape_string($data["position"]) . "', '" . mysql_real_escape_string($data["best_buddy"]) . "', '" . mysql_real_escape_string($data["credit"]) . "', '" . mysql_real_escape_string($data["ongoing_credit"]) . "', '" . mysql_real_escape_string($data["promo_code"]) . "', '" . mysql_real_escape_string($data["promo_cli"]) . "', '" . mysql_real_escape_string($data["promo_plan"]) . "', '" . mysql_real_escape_string($data["onceoff_credit"]) . "', '" . mysql_real_escape_string($data["payway"]) . "', '" . mysql_real_escape_string($data["dd_type"]) . "', '" . mysql_real_escape_string($billing_comments) . "', '" . mysql_real_escape_string($other_comments) . "')") or die(mysql_error());
