...
<th style='text-align:center;' width="26%">Access</th>
<th style='text-align:center;' width="9%">Centre</th>
<th style='text-align:center;' width="11%">Status</th>
<th colspan="4" style='text-align:center;' width="17%">Edit User</th>
</tr>
</thead>
<tbody>
<?php
if ($query == "")
{
	...
	{
		$st = $_GET["page"]*15;
		$q = mysql_query("SELECT * FROM vericon.auth ORDER BY user ASC LIMIT $st , 15") or die(mysql_error());
		...
		while($r = mysql_fetch_assoc($q))
		{
			...
			echo "<td style='text-align:center;'><button onclick='Modify_Access(\"$r[user]\")' class='icon_access' title='Edit Access'></button></td>";
