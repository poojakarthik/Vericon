...
<th width='15%'>Last Action Time</th>
...
while($current = mysql_fetch_assoc($q))
{
	if ($i == 100)
	{
		...
		echo "<th width='15%' style='text-align:left;'>Name</th>";
	...
	echo "<td><button onclick='Logout_User(\"$current[user]\")' class='icon_logout' title='Logout'></button></td>";
	echo "</tr>";
	$i++;
}
?>
