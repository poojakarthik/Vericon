...
?>
<script>
function Admin03_Create_Error(text)
{
	$( "#Admin03_create_error" ).html('<div class="ui-state-error ui-corner-all" style="padding: 0 .7em;"><p style="padding: 9px 0;"><span class="ui-icon ui-icon-alert" style="float: left; margin-right: .3em;"></span>' + text + '</p></div>');
}

function Admin03_Create_User_Cancel()
{
	V_Page_Reload();
}
...
function Admin03_Portal_Select(portal)
{
	...
	{
		$( "#Admin03_cu_centre_tr" ).removeAttr("style");
		$( "#Admin03_cu_designation_tr" ).removeAttr("style");
	}
	else
	{
		$( "#Admin03_cu_centre_tr" ).attr("style","display:none;");
		$( "#Admin03_cu_designation_tr" ).attr("style","display:none;");
	}
	
	if ($.inArray("CS",$( "#Admin03_access" ).val()) != -1 || $.inArray("TPV",$( "#Admin03_access" ).val()) != -1 || $.inArray("Sales",$( "#Admin03_access" ).val()) != -1)
	{
		$( "#Admin03_cu_alias_tr" ).removeAttr("style");
	}
	else
	{
		$( "#Admin03_cu_alias_tr" ).attr("style","display:none;");
	}
	
	if ($.inArray("Operations",$( "#Admin03_access" ).val()) != -1 || $.inArray("HR",$( "#Admin03_access" ).val()) != -1)
	{
		$( "#Admin03_cu_centres_tr" ).removeAttr("style");
	}
	else
	{
		$( "#Admin03_cu_centres_tr" ).attr("style","display:none;");
	}
...
function Admin03_Create_User_Check(field)
{
	...
	$.post("/admin/users_process.php", { m: "check", field: field, input: input.val(), input2: input2 }, function(data) {
		if (data == "valid")
		{
			...
			$( "#Admin03_create_error" ).html("<p>Enter the user's details below to create the account.</p>");
		}
		else
		{
...
function Admin03_Create_User_Submit()
{
	...
	$.post("/admin/users_process.php", { m: "create", first: first.val(), last: last.val(), password: password.val(), password2: password2.val(), access: access.val(), centres: centres.val(), centre: centre.val(), designation: designation.val(), alias: alias.val(), pages: pages }, function(data) {
...
<table>
<tr>
<td colspan="2" id="Admin03_create_error"><p>Enter the user's details below to create the account.</p></td>
<td></td>
</tr>
<tr>
...
<td><input id="Admin03_first" onchange="Admin03_Create_User_Check('first')" type="text"></td>
<td id="Admin03_first_check" style="padding-left:5px;"></td>
</tr>
<tr>
<td>Last Name<span style="color:#ff0000;">*</span> </td>
<td><input id="Admin03_last" onchange="Admin03_Create_User_Check('last')" type="text"></td>
<td id="Admin03_last_check" style="padding-left:5px;"></td>
</tr>
<tr>
<td>Password<span style="color:#ff0000;">*</span> </td>
<td><input id="Admin03_password" onchange="Admin03_Create_User_Check('password')" type="password"></td>
<td id="Admin03_password_check" style="padding-left:5px;"></td>
</tr>
<tr>
<td>Re-Type Password<span style="color:#ff0000;">*</span> </td>
<td><input id="Admin03_password2" onchange="Admin03_Create_User_Check('password2')" type="password"></td>
...
<tr id="Admin03_cu_centres_tr" style="display:none;">
...
<tr id="Admin03_cu_centre_tr" style="display:none;">
...
<tr id="Admin03_cu_designation_tr" style="display:none;">
...
<tr id="Admin03_cu_alias_tr" style="display:none;">
<td>Alias<span style="color:#ff0000;">*</span> </td>
<td><input id="Admin03_alias" onchange="Admin03_Create_User_Check('alias')" type="text"></td>
...
<button onclick="Admin03_Create_User_Submit()" class="btn">Submit</button> <button onclick="Admin03_Create_User_Cancel()" class="btn" style="margin-left:10px;">Cancel</button>
</td>
</tr>
</table>
</div></center>