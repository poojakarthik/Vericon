	...
	$( "#datepicker" ).datepicker( {
		...
		onSelect: function(dateText, inst) {
			...
			$( "#display2" ).hide('blind','','slow', function() {
				$( "#display2" ).load("agent_display3.php?user=" + user.val() + '&date1=' + dateText + '&date2=' + date2.val(),
				function() {
...
$(function() {
	$( "#datepicker3" ).datepicker( {
		...
		onSelect: function(dateText, inst) {
			...
			$( "#display2" ).hide('blind','','slow', function() {
				$( "#display2" ).load("agent_display3.php?user=" + user.val() + '&date1=' + date1.val() + '&date2=' + dateText,
				function() {
					$( "#display2" ).show('blind','','slow');
				});
			});
