...
$rcmail_config['default_host'] = 'ssl://mail.vericon.com.au';
...
// For example %n = mail.domain.tld, %d = domain.tld
$rcmail_config['smtp_server'] = 'tls://mail.vericon.com.au';
...
$rcmail_config['skin_logo'] = '/images/vericon_logo.png';
...
$rcmail_config['session_name'] = 'vc_mail_id';
...
$rcmail_config['des_key'] = 'mtk3r$5T-+VJjIH0hQ78h=ns';
...
// %z - IMAP domain (IMAP hostname without the first part)
// For example %n = mail.domain.tld, %d = domain.tld
$rcmail_config['mail_domain'] = 'vericon.com.au';
...
$rcmail_config['useragent'] = 'VeriCon Mail/'.RCMAIL_VERSION;

// use this name to compose page titles
$rcmail_config['product_name'] = 'VeriCon :: Mail';
...
$rcmail_config['dont_override'] = array('logout_purge', 'draft_autosave', 'skip_deleted', 'read_when_deleted', 'flag_for_deletion', 'delete_always', 'drafts_mbox', 'junk_mbox', 'sent_mbox', 'trash_mbox');
...
$rcmail_config['time_format'] = 'h:i A';
...
$rcmail_config['default_font'] = 'Tahoma';
