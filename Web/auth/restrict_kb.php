...
$referer = $_SERVER['SERVER_NAME'] . "/kb/";
...
$mysqli->query("UPDATE `vericon`.`current_users` SET `last_action` = NOW() WHERE `user` = '" . $mysqli->real_escape_string($ac["user"]) . "'") or die($mysqli->error);
?>