...
function View_Edit()
{
	...
	$( "#display2" ).hide('blind', '' , 'slow', function() {
		$( "#display2" ).load('timesheet_edit.php?date=' + date.val(),
		function() {
...
function Save()
{
	...
	$.get("timesheet_process.php", { method: "save", date: date.val(), users: users, start: start, end: end, hours: hours }, function(data) {
		$( "#display2" ).hide('blind', '' , 'slow', function() {
			$( "#display2" ).load('timesheet_view.php?date=' + date.val(),
			function() {
				$( "#display2" ).show('blind', '' , 'slow');
			});
		});
...
function Export()
{
	...
	window.location = 'timesheet_export.php?date=' + date.val();
}
</script>
...
$( "#display" ).load("timesheet_display.php?date=" + date, function() {
	$( "#display2" ).load('timesheet_view.php?date=' + date, function() {
