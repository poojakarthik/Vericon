...
<h3 style="font-weight:bold; text-align:left;"><a href="">Customer Conversion</a></h3>
<div style="padding:0px;">
<div id="users-contain" class="ui-widget" style="width:100%; margin:0px;">
<table id="users" class="ui-widget ui-widget-content" style="width:100%; margin:0px;">
<?php //captive
$total_b_approved = 0;
$total_r_approved = 0;
$total_approved = 0;
