...
<head>
<title>VeriCon :: Self Verification :: Sales Form</title>
...
<p class="error2">Please select a sale type and campaign</p><br />
<table>
<tr>
...
<tr>
<td>Type </td>
<td><select id="type" style="width:120px; height:auto; padding:0px; margin:0px;">
<option></option>
...
else
{
	...
	if ($lead_val[0] == 1)
	{
		...
		elseif (($check["centre"] != $ac["centre"] && strtoupper($check["centre"]) != "KAMAL") && ($check["centre"] != $ac["centre"] && strtoupper($check["centre"]) != "SANJAY"))
		{
