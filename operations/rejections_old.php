...
$(function() {
	$( "#datepicker" ).datepicker( {
		...
		onSelect: function(dateText, inst) {
			...
			$( "#display" ).load('rejections_display.php?method=display&user=' + user + '&date1=' + dateText + '&date2=' + date2.val());
		}});
});
</script>
<script>
$(function() {
	$( "#datepicker3" ).datepicker( {
		...
		onSelect: function(dateText, inst) {
			...
			$( "#display" ).load('rejections_display.php?method=display&user=' + user + '&date1=' + date1.val() + '&date2=' + dateText);
		}});
});
</script>
<script>
...
function View(centre)
{
	...
	$( ".cent" ).html(centre);
	$( "#rejection_view" ).load('rejections_display.php?method=rejection&centre=' + centre + '&date1=' + date1.val() + '&date2=' + date2.val());
