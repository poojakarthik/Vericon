...
<li><a href="../operations/report.php">REPORTS</a></li><?php if ($ac["user"] == "vkoc001" || $ac["user"] == "nshe001" || $ac["user"] == "kdar001" || $ac["user"] == "nrat001" || $ac["user"] == "onaj001" || $ac["user"] == "bsha001") { ?><li style="padding-top:8px;">|</li>
