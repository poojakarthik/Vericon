...
elseif ($type == "display")
{
	...
	if (substr($id,0,2) == "GA")
	{
		...
		echo $street_number . " " . $street_name . " " . $street_type . "}" . $suburb . "}" . $state . "}" . $postcode;
	...
	elseif (substr($id,0,2) == "MA")
	{
		...
		echo $building_type . " " . $building_number . " " . $building_name . " " . $street_number . " " . $street_name . " " . $street_type . "}" . $suburb . "}" . $state . "}" . $postcode;
	}
}
?>