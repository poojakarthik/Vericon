...
<th colspan="2" style='text-align:center;' width="20%">Edit User</th>
</tr>
</thead>
<tbody>
<?php
if ($query == "")
{
	...
	$check = mysql_query("SELECT * FROM vericon.auth WHERE type LIKE '%QA%'") or die(mysql_error());
	...
	{
		$st = $_GET["page"]*15;
		$q = mysql_query("SELECT * FROM vericon.auth WHERE type LIKE '%QA%' ORDER BY user ASC LIMIT $st , 15") or die(mysql_error());
