			...
			"Add Package": function() {
				...
				else
				{
					...
					function(data) {
						if (data == "added")
						{
							$( "#packages" ).load('../tpv/packages_nz.php?id=' + id.val());
...
{
	$( "#plan" ).val("");
	$( "#plan" ).load("../tpv/plans_nz.php?id=" + $( "#id" ).val() + "&type=" + $( "#sale_type" ).val() + "&cli=" + $('#cli').val());
}
</script>
...
function LoadScript()
{
	...
	$.get("verification_submit.php?method=script_check", { id: id.val() }, function(data) {
		if (data == "valid")
		{
			$( "#display" ).hide('blind', '' , 'slow', function() {
				$( "#display" ).load('verification_script_nz.php?id=' + id.val(), function() {
...
<table width="100%">
<tr>
<td style="padding-left:5px;"><img src="../images/sale_notes_header.png" width="85" height="15"></td>
</tr>
<tr>
