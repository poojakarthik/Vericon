...
<div id="users-contain" class="ui-widget">
	<table id="users" class="ui-widget ui-widget-content">
		...
		if ($query == "")
		{
			$check = mysql_query("SELECT * FROM auth WHERE type LIKE '%sales%' AND centre = '$ac[centre]'") or die(mysql_error());
			...
			{
				$st = $_GET["page"]*10;
				$q = mysql_query("SELECT * FROM auth WHERE type LIKE '%sales%' AND centre = '$ac[centre]' LIMIT $st , 10") or die(mysql_error());
		...
		{
			$check = mysql_query("SELECT * FROM auth WHERE " . $method . " LIKE '%" . mysql_escape_string($query) . "%' AND type LIKE '%sales%' AND centre = '$ac[centre]'") or die(mysql_error());
			$rows = mysql_num_rows($check);
			...
			{
				$st = $_GET["page"]*10;
				$q = mysql_query("SELECT * FROM auth WHERE " . $method . " LIKE '%" . mysql_escape_string($query) . "%' AND type LIKE '%sales%' AND centre = '$ac[centre]' ORDER BY user ASC LIMIT $st , 10") or die(mysql_error());
